...
<style>
    ...
    /* Panel kiri dirender di dalam kolom Streamlit biasa (bukan position:fixed),
       supaya tidak bergantung pada nama elemen internal Streamlit yang bisa berubah
       antar versi dan menyebabkan tumpang tindih. */
    .login-brand {{
        background: linear-gradient(165deg, {INK} 0%, {NAVY_DEEP} 100%);
        display: flex; flex-direction: column; justify-content: space-between;
        padding: 48px 40px; box-sizing: border-box; min-height: 560px;
    ...
    .login-card-wrap {{ padding: 6vh 8% 4vh; max-width: 460px; }}
